...
{
	public string brokerIpAddress = "192.168.0.113"; /*mosquitto = 127.0.0.1:1883*/
	...
	private string temperatureMessage = "26";
	...
	void client_MqttMsgPublishReceived(object sender, MqttMsgPublishEventArgs e)
	{
		...
		if (e.Topic.Equals(temperatureTopic))
			temperatureMessage = lastMessage;
	}

	void Update()
	{
		displayText.text = temperatureMessage + " C";
